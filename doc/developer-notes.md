...
NodeLab Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as NodeLab Core, where everyone uses
...
pay attention to for reviewers of NodeLab Core code.

General NodeLab Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NodeLab Core uses tinyformat, which is type safe. Leave them out to avoid confusion
