...
This mechanism has been integrated into Bitcore-Node-NodeLab which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nodelabcoin/insight-api-nodelab#web-socket-api](https://github.com/nodelabcoin/insight-api-nodelab#web-socket-api) 
* API: [https://github.com/nodelabcoin/insight-api-nodelab#instantsend-transactions](https://github.com/nodelabcoin/insight-api-nodelab#instantsend-transactions) 
...
By default, the NodeLab Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NodeLab Core daemon:
