...
Only requiring some minor changes is nodelab.cpp.
...
Changes to nodelab.cpp
----------------------
nodelab.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
