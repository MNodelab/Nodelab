...
pkgdatadir = $(datadir)/nodelabcore
pkgincludedir = $(includedir)/nodelabcore
pkglibdir = $(libdir)/nodelabcore
pkglibexecdir = $(libexecdir)/nodelabcore
...
CONFIG_HEADER = $(top_builddir)/src/config/nodelab-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/nodelab-config.h.in \
...
ACLOCAL = ${SHELL} /home/node3/Nodelab/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/node3/Nodelab/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/node3/Nodelab/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/node3/Nodelab/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = nodelab-cli
BITCOIN_DAEMON_NAME = nodelabd
BITCOIN_GUI_NAME = nodelab-qt
BITCOIN_TX_NAME = nodelab-tx
...
COPYRIGHT_HOLDERS_FINAL = The NodeLab Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = NodeLab Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/node3/Nodelab/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = nodelabcore
PACKAGE_BUGREPORT = https://github.com/NicholasAdmin/NodeLab/issues
PACKAGE_NAME = NodeLab Core
PACKAGE_STRING = NodeLab Core 1.0.0
PACKAGE_TARNAME = nodelabcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/node3/Nodelab
abs_srcdir = /home/node3/Nodelab
abs_top_builddir = /home/node3/Nodelab
abs_top_srcdir = /home/node3/Nodelab
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/node3/Nodelab/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/nodelabd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/nodelab-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/nodelab-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = NodeLab-Qt.app
OSX_DMG = NodeLab-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_nodelab_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_nodelab_coverage.info test_nodelab.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/NodeLab-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/nodelab-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/nodelab-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/nodelab-config.h
$(top_srcdir)/src/config/nodelab-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/nodelab-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/NodeLab-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NodeLab-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "NodeLab-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/NodeLab-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_nodelab.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_nodelab -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_nodelab_filtered.info: test_nodelab.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_nodelab_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_nodelab_filtered.info
...
#test_nodelab_coverage.info: baseline_filtered_combined.info test_nodelab_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nodelab_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_nodelab_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_nodelab_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nodelab.coverage/.dirstamp:  test_nodelab_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_nodelab.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_nodelab.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
