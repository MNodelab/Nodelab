...
2. run nodelabd with -printalert or -sendalert like this:
   /path/to/nodelabd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://nodelabcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/NodeLab Core:0.12.0.58/"));
