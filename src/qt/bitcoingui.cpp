    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NodeLab Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NodeLab address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodelab: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NodeLab Core"), this);
    aboutAction->setStatusTip(tr("Show information about NodeLab Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NodeLab Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NodeLab addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NodeLab addresses"));
    ...
    openAction->setStatusTip(tr("Open a nodelab: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NodeLab Core help message to get a list with possible NodeLab Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NodeLab Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NodeLab network", "", count));
}
...
{
    QString strTitle = tr("NodeLab Core"); // default title
