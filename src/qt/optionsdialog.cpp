    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NLAB-light"), QVariant("light"));
    ui->theme->addItem(QString("NLAB-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NLAB-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NLAB-traditional"), QVariant("trad"));
