    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("NodeLab Core");
    ...
    QString copyrightTextNodeLab   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The NodeLab Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextNodeLab);
