    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NodeLab Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NodeLab Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  nodelab-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NodeLab in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an nodelabtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 NLAB, 0.1 NLAB, 1 NLAB and 10 NLAB -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nodelabcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://nodelabcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NodeLab Core is shutting down...") + "<br /><br />" +
