...
// Copyright (c) 2014-2018 The NodeLab Core developers
...
{
    const char* pszTimestamp = "Nodelab coin start 04/07/2018";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 990458; // blocks
        consensus.nMasternodePaymentsStartBlock = 3601; // block 3601
        ...
        consensus.nPowTargetTimespan = 2 * 60; // NodeLab: every blocks
        consensus.nPowTargetSpacing = 2 * 60; // NodeLab: 2 minutes
        ...
        genesis = CreateGenesisBlock(1530694607, 354658, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("000000d1be4d99c8ffda57f9f9f076de1db64cbcd16991a0a66a88a2181c8a80"));
        assert(genesis.hashMerkleRoot == uint256S("d1206de6e78bd116e319355bbed47d81ca8bfd72bfdf411ee02c44712147e123"));
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.nodelab.team"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.nodelab.team"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.nodelab.team"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.nodelab.team"));
        // NodeLab addresses start with 'N'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // NodeLab script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // NodeLab private keys start with 'E'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,33);
        // NodeLab BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // NodeLab BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // NodeLab BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("000000d1be4d99c8ffda57f9f9f076de1db64cbcd16991a0a66a88a2181c8a80")),
            1530694607, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60; // NodeLab: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // NodeLab: 2 minutes
   ...
   //     assert(genesis.hashMerkleRoot == uint256S("0x33a98e8f8089165dc24358b01d52dd740011bdbffad052d51d3ac3588af2f487"));
        ...
        // Testnet NodeLab addresses start with 'N'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // Testnet NodeLab script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,33);
        // Testnet NodeLab BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet NodeLab BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet NodeLab BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams() {
        ...
        // Regtest NodeLab addresses start with 'N'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // Regtest NodeLab script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Regtest private keys start with '5' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest NodeLab BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest NodeLab BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest NodeLab BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
