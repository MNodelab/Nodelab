...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NodeLabNetwork") type = NodeLabNetwork;
    if(strType == "NodeLabNetworkVariable") type = NodeLabNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NodeLabNetwork) s = "NodeLabNetwork";
    if(type == NodeLabNetworkVariable) s = "NodeLabNetworkVariable";
