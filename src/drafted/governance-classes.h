 ...
 *
 *   // network
 *   CNodeLabNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nodelabcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNodeLabNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CNodeLabNetwork(UniValue objIn)
    {
...
// // can be under: NodeLabNetwork
// //   -- signature requirements : Key1(User)
// class CNodeLabNetworkVariable : public CGovernanceObject
// {
// private:
