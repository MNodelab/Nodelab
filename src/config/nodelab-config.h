/* src/config/nodelab-config.h.  Generated from nodelab-config.h.in by configure.  */
/* src/config/nodelab-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NODELAB_CONFIG_H

#define NODELAB_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The NodeLab Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "NodeLab Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/NodeLab/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NodeLab Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NodeLab Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nodelabcore"
