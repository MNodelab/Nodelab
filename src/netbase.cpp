...
static bool Socks5(const std::string& strDest, int port, const ProxyCnodelabtials *auth, SOCKET& hSocket)
{
...
static bool ConnectThroughProxy(const proxyType &proxy, const std::string& strDest, int port, SOCKET& hSocketRet, int nTimeout, bool *outProxyConnectionFailed)
{
    ...
    if (proxy.randomize_cnodelabtials) {
        ProxyCnodelabtials random_auth;
