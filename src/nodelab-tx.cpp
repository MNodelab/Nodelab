...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("NodeLab Core nodelab-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nodelab-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodelab transaction") + "\n" +
              "  nodelab-tx [options] -create [commands]   " + _("Create hex-encoded nodelab transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodelab transaction
